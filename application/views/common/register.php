<div class="col-sm-12">
	...
	<div class="col-sm-6 finitial center-block">
		<form class="form-horizontal" onsubmit="return joinCheck(this)" action="/auth/register" method="post">
			<fieldset>
				<div id="joinFormEmail" class="form-group">
					<!-- E-mail -->
				...
				<div id="joinFormNick" class="form-group">
					<!-- Username -->
				...
				<div id="joinFormPw" class="form-group">
					<!-- Password-->
					<label class="control-label col-sm-3" for="joinPassword">비밀번호</label>
					<div class="col-sm-9">
						<input type="password" id="joinPassword" name="joinPassword" value="<?php echo set_value('joinPassword'); ?>" placeholder="4 자 이상 20 자 미만 비밀번호를 입력해 주세요." class="form-control" minlength="6" maxlength="30"">
					</div>
					<div class="col-sm-offset-3 col-sm-9">
				...
				<div id="joinFormPwC" class="form-group">
					<!-- Password -->
					<label class="control-label col-sm-3" for="joinPwConfirm">비밀번호 확인</label>
					<div class="col-sm-9">
						<input type="password" id="joinPwConfirm" name="joinPwConfirm" value="<?php echo set_value('joinPwConfirm'); ?>" placeholder="비밀번호를 한번 더 입력해 주세요." class="form-control" minlength="6" maxlength="30">
					</div>
					<div class="col-sm-offset-3 col-sm-9">
